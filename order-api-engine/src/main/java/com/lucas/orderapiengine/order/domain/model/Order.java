...
public class Order {
    ...
    public static Order create(List<OrderItem> items, OrderPaymentDetails paymentDetails) {
        validateItems(items);
        ...
        order.addEvent(new OrderCreatedEvent(order.id, order.totalAmount, order.paymentDetails));
